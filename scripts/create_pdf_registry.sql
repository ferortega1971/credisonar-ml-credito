...
CREATE TABLE IF NOT EXISTS Cobranza_pdf_evaluaciones (
    ...
    score_datacredito INT COMMENT 'Score de Datacrédito reportado en la evaluación',
    ingresos_reportados DECIMAL(15,2) COMMENT 'Ingresos mensuales reportados en la evaluación',
    egresos_reportados DECIMAL(15,2) COMMENT 'Egresos totales reportados en la evaluación',
